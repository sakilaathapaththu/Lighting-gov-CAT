...
@section('content')
    <form method="POST" action="{{ route('govofficials.update', $govofficial->id) }}">
        ...
        <div class="container" data-aos="fade-down" data-aos-duration="1000" id="div1"
            style="font-family:poppins;background: linear-gradient(to top right, #660066 56%, #FF6699 100%);border-radius:10px;padding-bottom:3%;margin-bottom:2%">
            ...
            <div class="container" style="background:#fff;border-radius:10px;width:80%:">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Full Name<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="full_name" name="full_name" type="text"
                                placeholder="Enter Full Name" style="width:80%;margin-left:10%" required
                                value="{{ Auth::user()->govofficial->full_name }}">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Preferred Name<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="preferred_name" name="preferred_name" type="text"
                                placeholder="Enter Preferred Name" style="width:80%;margin-left:10%" required
                                value="{{ Auth::user()->govofficial->preferred_name }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Designation<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="designation" name="designation" type="text"
                                placeholder="Enter Designation" style="width:80%;margin-left:10%" required
                                value="{{ Auth::user()->govofficial->designation }}">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Organization Name<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            {{-- <input class="form-control-lg" type="text" placeholder="Select Organization Name"
                                style="width:80%;margin-left:10%"
                                value="{{ Auth::user()->govofficial->govorganizationname->gov_org_name }}" readonly>
                            <input type="hidden" name="gov_org_name" id="gov_org_nameid"
                                value="{{ Auth::user()->govofficial->govorganizationname_id }}"> --}}
                            ...
                            <select class="form-select form-select-lg mb-3" id="gov_org_nameid" name="gov_org_name"
                                style="width: 80%; margin-left: 10%; height: 50px;">
                                <option>Select</option>
                                @foreach ($govnames as $row)
                                    <option value="{{ $row->id }}"
                                        {{ $govofficial->govorganizationname_id == $row->id ? 'selected="selected"' : '' }}>
                                        {{ $row->gov_org_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Contact Number<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            {{-- <input class="form-control-lg" id="contact_number" name="contact_number" type="text"
                                placeholder="Enter the Contact Number" style="width:80%;margin-left:10%" required
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Email address<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            {{-- <input class="form-control-lg" id="email" name="email" type="text"
                                placeholder="Enter the email address" style="width:80%;margin-left:10%" required
                                value="{{ Auth::user()->govofficial->email }}"> --}}
                                <input class="form-control-lg" id="email" name="email" type="text"
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Employment Layer<span style="color: red;">*</span>
                            </h5>
                        </div>
                        <div class="row">
                            {{-- <input class="form-control-lg" id="employment_layer" name="employment_layer" type="text"
                                placeholder="Select the Employment Layer" style="width:80%;margin-left:10%"
                                value="{{ Auth::user()->govofficial->employment_layer }}"> --}}


                                <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                                id="employment_layer" name="employment_layer" style="width:80%;margin-left:10%"
                                data-toggle="tooltip" data-placement="bottom">
                                <option value="" disabled selected>Select the Employment Layer</option>
                                <option value="top"
                                    {{ Auth::user()->govofficial->employment_layer == 'top' ? 'selected' : '' }}>Top and
                                    Second Tier Management</option>
                                <option value="cdio"
                                    {{ Auth::user()->govofficial->employment_layer == 'cdio' ? 'selected' : '' }}>Chief
                                    Digital Information Officer (CDIO)</option>
                                <option value="middle"
                                    {{ Auth::user()->govofficial->employment_layer == 'middle' ? 'selected' : '' }}>Middle
                                    and Junior Management</option>
                                <option value="operational"
                                    {{ Auth::user()->govofficial->employment_layer == 'operational' ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Date of Birth<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                           
                                <input class="form-control-lg" id="date_of_birth" name="date_of_birth" type="date"
                                style="width: 80%; margin-left: 10%"
                                value="{{ Auth::user()->govofficial->date_of_birth }}" min="1900-01-01"
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="linkedin" name="linkedin" type="text"
                                placeholder="Paste Here" style="width:80%;margin-left:10%"
                                value="{{ Auth::user()->govofficial->linkedin }}">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="row" style="margin-top:1%">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="facebook" name="facebook" type="text"
                                placeholder="Paste Here" style="width:80%;margin-left:10%"
                                value="{{ Auth::user()->govofficial->facebook }}">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="row" style="margin-top:1%">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="instagram" name="instagram" type="text"
                                placeholder="Paste Here" style="width:80%;margin-left:10%"
                                value="{{ Auth::user()->govofficial->instagram }}">
                        </div>
                ...
                <div class="row" style="margin-top:3%;padding-bottom:3%">
                    <div class="col-6" style="text-align:right">
                        <button data-bs-toggle="modal" data-bs-target="#cancel" class="btn btn-primary" type="reset"
        ...
        <div class="modal fade" style="font-family:poppins" id="cancel" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger" type="button" style="font-family: Poppins;border-width:0px;"
                            href="{{ route('userHome') }}">Yes</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-success" type="submit"
                            style="font-family: Poppins;border-width:0px;">Yes</button>
                        <form action="{{ route('govofficials.update', $govofficial->id) }}" method="PUT"
                            class="d-none">
                            @csrf
                        </form>
                    </div>
