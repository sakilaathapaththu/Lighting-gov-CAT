        ...
        <div class="container" data-aos="fade-down" data-aos-duration="1000" id="div1"
            ...
            <div class="container" style="background:#fff;border-radius:10px;width:80%:">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Full Name<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="full_name" name="full_name" type="text"
                                placeholder="Enter Full Name" style="width:80%;margin-left:10%" value="" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Preferred Name<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="preferred_name" name="preferred_name" type="text"
                                placeholder="Enter Preferred Name" style="width:80%;margin-left:10%" value=""
                                required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Designation<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="designation" name="designation" type="text"
                                placeholder="Enter Designation" style="width:80%;margin-left:10%" value="" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Organization Name<span style="color: red;">*</span>
                            </h5>
                        </div>
                        <div class="row">
                            <select class="form-select form-select-lg mb-3" id="gov_org_nameid" name="gov_org_name"
                                style="width: 80%; margin-left: 10%; height: 50px;" required>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Contact Number<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="contact_number" name="contact_number" type="text"
                                placeholder="Enter the Contact Number" style="width:80%;margin-left:10%" value=""
                                oninput="validateContactNumber(this)" pattern="\d{10}" required>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Email address<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Employment Layer<span style="color: red;">*</span>
                            </h5>
                        </div>
                        <div class="row">
                            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                                id="employment_layer" name="employment_layer" placeholder="Select the Employment Layer"
                                style="width:80%;margin-left:10%" data-toggle="tooltip" data-placement="bottom"
                                value=""
                                title='
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#000000">Date of Birth<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                            <input class="form-control-lg" id="date_of_birth" name="date_of_birth" type="date"
                                style="width: 80%; margin-left: 10%" value="" min="1900-01-01" required
                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="linkedin" name="linkedin" type="text"
                                placeholder="Paste Here" style="width:80%;margin-left:10%" value="">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="row" style="margin-top:1%">
                ...
                <div class="row" style="margin-top:3%;padding-bottom:3%">
                    ...
                    <div class="col-6" style="text-align:left">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#update" type="button"
                            style="background: linear-gradient(to bottom right, #F44567 0%, #F97B5F 49%);text-align: center;border-color: rgb(254,80,57);">Submit</button>
                    </div>
                    <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                </div>
            </div>
