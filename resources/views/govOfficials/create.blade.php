                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="full_name" name="full_name" type="text"
                                placeholder="Enter Full Name" style="width:80%;margin-left:10%" value="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="designation" name="designation" type="text"
                                placeholder="Enter Designation" style="width:80%;margin-left:10%" value="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="date_of_birth" name="date_of_birth" type="date"
                                style="width: 80%; margin-left: 10%" value="" min="1900-01-01"
