                ...
                <table class="table">
                    ...
                    <tbody style="font-size: 12px;">
                        ...
                        <tr style="font-size: 12px;">
                            ...
                            <td style="font-size: 12px;"><br>Results orientation to achieve desired outcomes and sustain
                                stakeholder satisfaction in digital government</td>
                        </tr>
                        <tr style="font-size: 12px;">
                ...
                <table class="table">
                    <thead style="background: var(--bs-table-border-color);">
                        <tr style="background: var(--bs-table-border-color);height: 60px;">
                            <th
                                style="width: 400px;font-size: 20px;font-family: poppins;background: var(--bs-table-border-color);border-left-style: solid;border-left-color: var(--bs-table-striped-color);">
                                <br>Competency Area<br><br></th>
                            <th
                                style="width: 300px;font-size: 20px;font-family: poppins;background: var(--bs-table-border-color);border-left-color: var(--bs-table-striped-color);">
                                <br>Proficiency<br><br></th>
                            <th
                                style="font-size: 20px;font-family: poppins;background: var(--bs-table-border-color);border-left-style: solid;border-left-color: var(--bs-table-color);">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td
                                ...
                                <br>{{ $avgmidChangeManagement }}%</td>
                            <td style="font-family: poppins;text-align: left;">
                                @if (
                                    $midProjectManagement2->dg1_1 == 0 ||
                                        $midProjectManagement2->dg1_2 == 0 ||
                                        $midProjectManagement2->dg1_3 == 0 ||
                                        $midProjectManagement2->dg1_4 == 0 ||
                                        $midProjectManagement2->dg1_5 == 0 ||
                                        $midProjectManagement2->dg2_1 == 0 ||
                                        $midProjectManagement2->dg2_2 == 0 ||
                                        $midProjectManagement2->dg2_3 == 0 ||
                                        $midProjectManagement2->dg2_4 == 0)
                        ...
                        <tr>
                            ...
                            <td style="font-family: poppins;text-align: left;">
                                ...
                                @endif
                                @if (
                                    $midChangeManagement2->dg6 == 0 ||
                                        $midChangeManagement2->dg7 == 0 ||
                                        $midChangeManagement2->dg8 == 0 ||
                                        $midChangeManagement2->dg9_1 == 0 ||
                                        $midChangeManagement2->dg9_2 == 0 ||
                                        $midChangeManagement2->dg9_3 == 0)
                        ...
                        <tr style="font-family: poppins;">
                            ...
                            <td
                                style="font-family: poppins;text-align: center;background: var(--bs-warning-bg-subtle);">
                                <br>{{ $avgmidCollaboration }}%</td>
                            <td style="font-family: poppins;text-align: left;box-shadow: 0px 0px;">
                                @if ($midCollaboration2->dg10 == 0)
                                    <br>Collaboration<br><br>
                                @endif
                                @if (
                                    $midCollaboration2->dg11_1 == 0 ||
                                        $midCollaboration2->dg11_2 == 0 ||
                                        $midCollaboration2->dg11_3 == 0 ||
                                        $midCollaboration2->dg11_4 == 0 ||
                                        $midCollaboration2->dg12 == 0)
                                    <br>Diversity<br><br>
                        ...
                        <tr>
                            ...
                            <td
                                style="background: var(--bs-warning-bg-subtle);font-family: poppins;text-align: center;">
                                <br>{{ $avgmidOrientatiion }}%</td>
                            <td style="text-align: left;font-family: poppins;">
                                @if (
                                    $midOrientation2->dg15 == 0 ||
                                        $midOrientation2->dg16_1 == 0 ||
                                        $midOrientation2->dg16_2 == 0 ||
                                        $midOrientation2->dg16_3 == 0 ||
                                        $midOrientation2->dg16_4 == 0)
                                ...
                                @endif
                                @if (
                                    $midOrientation2->dg19_1 == 0 ||
                                        $midOrientation2->dg19_2 == 0 ||
                                        $midOrientation2->dg19_3 == 0 ||
                                        $midOrientation2->dg19_4 == 0)
                        ...
                        <tr>
                            ...
                            <td
                                style="background: var(--bs-warning-bg-subtle);font-family: poppins;text-align: center;">
                                <br>{{ $avgmidQualityManagement }}%</td>
                            <td style="text-align: left;font-family: poppins;">
                                @if ($midQualityManagement2->dg20 == 0 || $midQualityManagement2->dg21 == 0)
                                    <br>Business Environmental Analysis<br><br>
                                @endif
                                @if (
                                    $midQualityManagement2->dg22_1 == 0 ||
                                        $midQualityManagement2->dg22_2 == 0 ||
                                        $midQualityManagement2->dg22_3 == 0 ||
                                        $midQualityManagement2->dg22_4 == 0)
                        ...
                        <tr>
                            <td style="font-family: poppins;"><br><br><br><br>Execute Digital Government
                                Initiatives<br><br></td>
                            <td
                                style="background: var(--bs-warning-bg-subtle);font-family: poppins;text-align: center;">
                                <br>{{ $avgmidInitiative }}%</td>
                            <td style="text-align: left;font-family: poppins;">
                                @if (
                                    $midInitiative2->dg26_1 == 0 ||
                                        $midInitiative2->dg26_2 == 0 ||
                                        $midInitiative2->dg26_3 == 0 ||
                                        $midInitiative2->dg27_1 == 0)
                                ...
                                @endif
                                @if (
                                    $midInitiative2->dg35_1 == 0 ||
                                        $midInitiative2->dg35_2 == 0 ||
                                        $midInitiative2->dg35_3 == 0 ||
                                        $midInitiative2->dg35_4 == 0)
                                    <br>Policy and procedure formulation<br><br>
                                @endif
                                @if (
                                    $midInitiative2->dg36_1 == 0 ||
                                        $midInitiative2->dg36_2 == 0 ||
                                        $midInitiative2->dg36_3 == 0 ||
                                        $midInitiative2->dg36_4 == 0)
