...
<section data-aos="fade-down" style="margin-bottom: 10px; text-align: center;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-xxl-7">
                    ...
                    <div class="row">
                        <div class="col" style="margin-top: 20px;"><a class="btn btn-primary" href="{{route('topDigitalGovernmentReport')}}" type="button" style="width: 203px;height: 55px;font-size: 20px;font-family: Poppins;background: url(&quot;{{ asset('img/Screenshot (561) 6.png') }}&quot;), var(--bs-body-bg);border-style: none;">Download</a></div>
                    </div>
