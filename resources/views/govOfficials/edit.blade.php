        ...
        <div class="container" data-aos="fade-down" data-aos-duration="1000" id="div1"
            ...
            <div class="container" style="background:#fff;border-radius:10px;width:80%:">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="full_name" name="full_name" type="text"
                                placeholder="Enter Full Name" style="width:80%;margin-left:10%"
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="preferred_name" name="preferred_name" type="text"
                                placeholder="Enter Preferred Name" style="width:80%;margin-left:10%"
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="designation" name="designation" type="text"
                                placeholder="Enter Designation" style="width:80%;margin-left:10%"
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            ...
                            {{-- <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                                id="organization_name" name="organization_name" style="width:80%;margin-left:10%">
                                <option value="" disabled selected>Select Organization Name</option>
                                @foreach ($organizations as $organization)
                                    <option value="{{ $organization->id }}"
                                        {{ Auth::user()->govofficial->govorganizationname_id == $organization->id ? 'selected' : '' }}>
                                        {{ $organization->gov_org_name }}
                                    </option>
                                @endforeach
                            </select> --}}
                            ...
                            {{-- <select class="form-select form-select-lg mb-3" id="gov_org_nameid" name="gov_org_name"
                                ...
                                @foreach ($govnames as $row)
                                    <option value="{{ $row->id }}">{{ $row->gov_org_name }}</option>
                                @endforeach
                            </select> --}}
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                            <h5 id="h4" style="color:#00000">Employment Layer<span style="color: red;">*</span></h5>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <input class="form-control-lg" id="date_of_birth" name="date_of_birth" type="date"
                                ...
                                max="<?php echo date('Y-m-d'); ?>" oninput="validateDateOfBirth(this)">
