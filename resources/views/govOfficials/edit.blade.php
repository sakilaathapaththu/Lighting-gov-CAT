                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="full_name" name="full_name" type="text"
                                ...
                                value="{{ Auth::user()->govofficial->full_name }}" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="preferred_name" name="preferred_name" type="text"
                                ...
                                value="{{ Auth::user()->govofficial->preferred_name }}"required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <input class="form-control-lg" id="designation" name="designation" type="text"
                                ...
                                value="{{ Auth::user()->govofficial->designation }}"required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <input class="form-control-lg" id="date_of_birth" name="date_of_birth" type="date"
                                ...
                                max="<?php echo date('Y') - 20 . '-' . date('m-d'); ?>" oninput="validateDateOfBirth(this)">
            ...
            <div class="modal-footer">
                ...
                <div class="row" style="margin-top:3%;padding-bottom:3%">
                    ...
                    <div class="col-6" style="text-align:left">
                        <button class="btn btn-primary" type="submit" onclick="showSuccessModal()"
