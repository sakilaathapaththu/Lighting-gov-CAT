...
<body>
    {{-- data-aos="fade-up" data-aos-duration="1000"  --}}
        <div class="container" id="div1"  style="margin-bottom: 5%;">
            <div class="row">
                ...
                <div class="row" style="margin-top:2%">
                        ...
                        <div class="col-6">
                            <h4 id="h4"  style="font-family: Poppins;text-align: left;color:#FF0000">No Data</h4>
                        </div>
                    </div>
                    <div class="row" style="margin-top:2%">
                        <div class="col-6">
                    ...
                    <div class="row" style="margin-top:2%">
                        ...
                        <div class="col-6">
                            <h4 id="gmail"  style="font-family: Poppins;text-align: left;color:#FF0000">No Data</h4>
                        </div>
                    </div>
                    <div class="row" style="margin-top:2%">
                        <div class="col-6">
                    ...
                    <div class="row" style="margin-top:2%">
                        ...
                        <div class="col-6">
                            <h4 id="h4-2"  style="font-family: Poppins;text-align: left;color:#FF0000">No Data</h4>
                        </div>
                    </div>
                    <div class="row" style="margin-top:2%">
                        <div class="col-6">
                ...
                <div id="div2" class="col-lg-4 col-sm-4" style="background: linear-gradient(to top right, #660066 56%, #FF6699 100%);">
                    <div class="row" >
                        <h3  id="click" style="font-family: Poppins, sans-serif;color:#fff;text-align: center;">Kindly complete the registration process prior to taking the assessment.</h3>
                    </div>
