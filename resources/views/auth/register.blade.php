        ...
        <div class="container" style=" background-color:#fff; border-radius:1%; font-family: Poppins, sans-serif;">
            ...
            <div class="row" style="margin-top:4%;">
                <div class="col-lg-6 col-md-6" style="margin-top:3%;">
                    <div class="row">
                        <h5 id="h5" style="margin-top:6%; color: #5F2B84; text-align:left;"> Create Password<span style="color: red;">*</span></h5>
                    </div>
                    <div class="row">
                        <input class="form-control-lg" id="password" name="password" type="password" placeholder="Enter the Password" style="width:80%;margin-left:10%" value="{{ old('password')}}" oninput="checkPassword(this)">
                ...
                <div class="col-lg-6 col-md-6" style="margin-top:3%;">
                    <div class="row">
                        <h5 id="h5" style="margin-top:6%; color: #5F2B84;text-align:left;"> Confirm Password<span style="color: red;">*</span></h5>
                    </div>
                    <div class="row">
            ...
            <div class="row" id="password-message" style="border-radius:1%; background: #D9D9D9; width:90%; margin-top:4%; margin-left:4%; display:none;">
                <h6 id="h6" style="color:#000; margin-top:3%; margin-bottum:3%;">Password must be at least&nbsp; 6 characters and contain at least one letter and one number. Passwords are case-sensitive.</h6>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col d-flex flex-column justify-content-center align-items-center align-content-center" style="margin-top: 5%;"><h5 id="h5" class="align-content-center" style="color: rgb(0,0,0);text-align: center;padding-bottom: 0px;">Existing user? Click here to&nbsp;<a href="{{ route('login') }}" style="color: #5F2B84;"><span style="color: rgb(0, 0, 0);">log in</span></a></h5><br><br></div>
            </div>
        </div>
    </form>
</div>
